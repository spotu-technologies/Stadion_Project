...
class TimerCamEmomCountView extends GetView<TimerCamEmomCountViewController> {
  const TimerCamEmomCountView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Get.put(TimerCamEmomCountViewController());
    return Scaffold(
      backgroundColor: colorScheme.background,
      body: GetBuilder<TimerCamEmomCountViewController>(builder: (controller) {
        return Stack(
          children: [
            ///바탕 이미지
            Image.asset(

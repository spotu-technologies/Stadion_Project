...
class SplashSecondViewController extends GetxController {
  void onInit() {
    super.onInit();
    Timer(
      Duration(milliseconds: 500),
          () => Get.to(() => StartView(),transition: Transition.cupertino),
    );
  }
}

class SplashSecondView extends GetView<SplashSecondViewController> {
  const SplashSecondView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Get.put(SplashSecondViewController());
    return Scaffold(
